...
export class Init1749119109671 implements MigrationInterface {
	...
	public async up(queryRunner: QueryRunner): Promise<void> {
		await queryRunner.query(
			`CREATE TABLE "user_session" ("id" SERIAL NOT NULL, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP DEFAULT now(), "deletedAt" TIMESTAMP, "version" integer NOT NULL DEFAULT '1', "refreshToken" character varying NOT NULL, "userAgent" character varying, "ipAddress" character varying, "createdById" integer, "updatedById" integer, "deletedById" integer, "userId" integer, CONSTRAINT "UQ_3c95f5a4cbd3bc44736fa8e6a0d" UNIQUE ("refreshToken"), CONSTRAINT "PK_adf3b49590842ac3cf54cac451a" PRIMARY KEY ("id"))`,
		);
		await queryRunner.query(
		...
		await queryRunner.query(
			`ALTER TABLE "user_session" ADD CONSTRAINT "FK_ac1fd0a456bc3a867aa3b469b5b" FOREIGN KEY ("createdById") REFERENCES "user"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
		);
		await queryRunner.query(
			`ALTER TABLE "user_session" ADD CONSTRAINT "FK_229b263934222f802af79c6663a" FOREIGN KEY ("updatedById") REFERENCES "user"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
		);
		await queryRunner.query(
			`ALTER TABLE "user_session" ADD CONSTRAINT "FK_e1d103cab937be665f3a268f211" FOREIGN KEY ("deletedById") REFERENCES "user"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
		);
		await queryRunner.query(
